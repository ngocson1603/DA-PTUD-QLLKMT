...
namespace GUI
{
    public partial class frmBackup : Form
    {
        ...
        private void BrownseBackup_Click(object sender, EventArgs e)
        {
        ...
        private void iconButton2_Click(object sender, EventArgs e)
        {
            ...
            {
                string cmd = "BACKUP DATABASE [" + database + "] TO DISK = '" + textBox1.Text + "\\" + "QL_CUAHANGLINHKIENMAYTINH" + ".bak'";
                conn.Open();
        ...
        private void BrownseRestore_Click(object sender, EventArgs e)
        {
